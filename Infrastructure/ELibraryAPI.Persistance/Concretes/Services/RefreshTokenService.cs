...
public class RefreshTokenService : IRefreshTokenService
{
    ...
    public async Task<string> CreateRefreshTokenAsync(AppUser user)
    {
        ...
        await _unitOfWork.RefreshTokenWrite.AddAsync(refreshToken);
        
        return rawToken;
    }

    public async Task<AppUser?> ValidateAndConsumeAsync(string rawToken)
    {
        var hashedToken = HashToken(rawToken);
        var refreshToken = await _unitOfWork.RefreshTokenRead.GetByTokenWithUserAsync(hashedToken);
